...
<head>
    ...
    <!-- Argon CSS -->
    <link type="text/css" href="./assets/css/kurumsal.css?v=1.1.1" rel="stylesheet">
    <link type="text/css" href="./assets/css/style.css?v=1.1.0" rel="stylesheet">
    <!-- Google Tag Manager -->
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
                new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
            j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
            'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
        })(window,document,'script','dataLayer','GTM-KL9WWW5');</script>
...
<section class="hfl">
    <div class="hfl1"><a href="https://api.whatsapp.com/send?phone=<?php echo str_replace(array(" ","+"),array("",""),$data["whatsapp"]); ?>"><img alt="" src="./assets/img/mb2.png" width="100%" ></a></div>
    <div class="hfl2"><a href="#bsa"><img alt="" src="./assets/img/mb1.png" width="100%" ></a></div>
</section>

<header class="header">
    <div class="container">
        <div class="row"><div class="col-12"><div class="logo-ar"><a href="index.php" aria-label="propertytr"><img alt="" src="./assets/img/logo.png" width="200" ></a></div></div></div>
            ...
            <div class="col-md-4 col-sm-4 col-0 kpt1">
                <div class="syhbg shadow">
                    ...
                    <form id="intro-register-form">
                        ...
                        <input required="required" type="text"  placeholder="<?php echo $lang["name_surname"]; ?>" name="name" id="name" class="kinput margin20">
                        <input required="required" type="text"  placeholder="<?php echo $lang["phone"]; ?>" name="phone" id="phone" class="kinput margin15">
                        <input required="required" type="text"  placeholder="<?php echo $lang["email"]; ?>" name="email" id="email" class="kinput margin15">
                        <select  required="required" class="ktlist11 margin15" name="subject" id="subject">
    ...
    <div class="container">
        ...
        foreach ($projects as $qq => $r){
            ...
            <div class="row margin40">
                <div class="col-lg-8 col-md-12 col-sm-12 ml-auto byz shadow">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 margin10 bold"><?php echo $r["location"]; ?></div>
                        <div class="col-lg-8 col-md-8 col-sm-12 tright"><span class="font22"><?php echo $r["name"]; ?></span></div>
                    </div>
                    <div class=" margin20">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="bgd">
                                        ...
                                        <div class="fright" style="font-size: 11px;"><?php echo $r["kutu2"]; ?></div>
                                    </div>
                                </div>
...
<script src="./assets/js/validate.js?v=1.0.3"></script>
<script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KL9WWW5"
