...
<head><meta http-equiv="Content-Type" content="text/html; charset=euc-jp">
 ...
 <?php if ($hakkimizda): foreach ($hakkimizda as $dizi):
         $desc=$dizi["about_description"];
         $tit=$dizi["about_title"];		 
 endforeach; endif;  ?> 
...
<section>
  ...
  <div class="container">
    ...
    <div class="row margin30">
      <div class="col-12"><span class="font15 bold"> <h1 class="font15 bold">  <?php echo $dizi["baslik"]; ?> </h1></span>
<p style="margin-top:20px"><?php echo $dizi["yazi"]; ?>
</p>
      </div>
    ...
    <div class="row">
     ...
     <div class="col-md-6 col-sm-12 mx-auto margin20">
        <div class="abt1">
          <span class="bold"><?php echo $dizi["alan_1_baslik"]; ?></span><div class="temiz"></div>
      ...
      <div class="col-md-6 col-sm-12 mx-auto margin20">
        <div class="abt1">
          <span class="bold"><?php echo $dizi["alan_2_baslik"]; ?></span><div class="temiz"></div>
      ...
      <div class="col-md-6 col-sm-12 mx-auto margin20">
        <div class="abt1">
          <span class="bold"><?php echo $dizi["alan_3_baslik"]; ?></span><div class="temiz"></div>
      ...
      <div class="col-md-6 col-sm-12 mx-auto margin20">
        <div class="abt1">
          <span class="bold"><?php echo $dizi["alan_4_baslik"]; ?></span><div class="temiz"></div>
      ...
      <div class="col-12 margin20">
        <div class="abt1">
          <span class="bold"><?php echo $dizi["alan_5_baslik"]; ?></span><div class="temiz"></div>
          <p><?php echo $dizi["alan_5_yazi"]; ?><p>
        </div>
      </div>
