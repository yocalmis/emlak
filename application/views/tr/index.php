...
<head><meta charset="euc-jp">
	...
	<?php  if ($ayar): foreach ($ayar as $dizi):
		$desc=$dizi["anasayfa_description"];
		$tit=$dizi["anasayfa_title"];		 
	endforeach; endif;   ?> 
...
<body>
	...
	if ( preg_match ( "/phone|iphone|itouch|ipod|symbian|android|htc_|htc-|palmos|blackberry|opera mini|iemobile|windows ce|nokia|fennec|hiptop|kindle|mot |mobile|pda;|avantgo|eudoraweb|minimo|netfront|brew|teleca|lg;|lge |wap;| wap |mot-|webos\/|samsung|sonyericsson|^sie-|nintendo/", $user_agent ) ) {  ?>
		<div class="projebox shadow">
			<a href="https://api.whatsapp.com/send?phone=9053596"><img alt="" src="<?php echo base_url(); ?>assets_user/tr/img/projebox.png"></a>
		</div>
	<?php }else{ ?>
	<?php } ?>
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="czg">
								<select name="kat" class="ktlist11">
									...
									echo'<option  value='.$dizi["kategori_id"].'>'.$dizi["kategori_adi"].'</option>';
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="czg">
								<select onchange="myFunctions()" name="tip" id="tip"  class="ktlist11">
									...
									echo'<option value='.$dizi["proje_tip_id"].'>'.$dizi["tip_adi"].'</option>';
									$n=$n+1; endforeach;endif;   ?>
								</select>
							</div>
	...
	<div class="carousel-inner">
		<div class="carousel-item active">
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 col-sm-6 col-6 mx-auto"><a title="<?php echo $dizi["proje_adi"]; ?>" href="<?php echo base_url(); ?><?php echo $dizi["seo_adi"]; ?>">
					<div class="f11 shadow">
						...
						<div class="f3">
							...
							<div class="f3-3" style="height:60px;"><?php echo $dizi["proje_adi"]; ?></div>
						</div>
					</div></a>
				</div>
	...
	<?php   if ($servis): foreach ($servis as $dizi): ?> 
		<div class="col-lg-3 col-md-6 col-sm-6 mx-auto margin30">
			...
			<div class="centerservices">
				...
				<h5><?php echo $dizi["alan_1_baslik"]; ?></h5>
				<p> <?php echo $dizi["alan_1_yazi"]; ?> </p>
		...
		<div class="col-lg-3 col-md-6 col-sm-6 mx-auto margin30">
			...
			<div class="centerservices">
				...
				<h5><?php echo $dizi["alan_2_baslik"]; ?></h5>
				<p> <?php echo $dizi["alan_2_yazi"]; ?> </p>
		...
		<div class="col-lg-3 col-md-6 col-sm-6 mx-auto margin30">
			...
			<div class="centerservices">
				...
				<h5><?php echo $dizi["alan_3_baslik"]; ?></h5>
				<p> <?php echo $dizi["alan_3_yazi"]; ?>  </p>
		...
		<div class="col-lg-3 col-md-6 col-sm-6 mx-auto margin30">
			...
			<div class="centerservices">
				...
				<h5><?php echo $dizi["alan_4_baslik"]; ?></h5>
				<p> <?php echo $dizi["alan_4_yazi"]; ?> </p>
...
-->
		...
		<div class="row">
			<?php   if ($manset_proje): foreach ($manset_proje as $dizi): ?> 
				...
				<div class="col-lg-3 col-md-6 col-sm-6 col-6 mx-auto margin30"><a title="<?php echo $dizi["kategori_adi"]; ?>" href="<?php echo base_url(); ?><?php echo $dizi["seo_adi"]; ?>">
					<div class="il1 shadow">
						...
						<div class="il2"><?php echo $dizi["kategori_adi"]; ?></div>
					</div>
				</a>
			</div>
				...
				<div class="carousel-item <?php echo $c; ?>">
					...
					<div class="carousel-caption">
						<div class="sl2">
							...
							<h2><?php echo $dizi["kim"]; ?></h2>
							<div class="sl2-2"><?php echo $dizi["yer"]; ?></div>
							<p class="kpt"><?php echo $dizi["yazi"]; ?></p>
						</div>
					</div>
		...
		<div class="row margin20">
			...
			<?php  if ($yeni_proje): foreach ($yeni_proje as $dizi): ?>  
				...
				<div class="col-lg-3 col-md-6 col-sm-6 col-6 mx-auto margin20">
					...
					<a title="<?php echo $dizi["proje_adi"]; ?>" href="<?php echo base_url(); ?><?php echo $dizi["seo_adi"]; ?>"><img alt="<?php echo $dizi["banner_2_alt"]; ?>" title="<?php echo $dizi["banner_2_title"]; ?>" src="<?php echo base_url(); ?>assets/resimler/<?php echo $dizi["banner_2"]; ?>" width="100%" class="sl0 shadow"></a>
					<div class="ur1">
						<div class="ur1-1">
							<span class="bold"><?php echo $dizi["proje_yeri"]; ?></span>
							<div class="ub1" style="height:70px;"><?php echo $dizi["proje_adi"];?></div>
						</div>
						<div class="ur1-2">
							<div class="ur1-21"><?php echo $dizi["min_fiyat"]*$this->session->userdata('para_birim'); ?>   <i class="fa-solid <?php echo $this->session->userdata('para_icon'); ?>"></i></div>
	...
	<section class="newsbg">
		...
		<div class="container">
			...
			<div class="row margin20">
				...
				<div class="col-3 tright margin15"><a class="all" href="news"><?php echo $this->session->userdata('ana_all_view'); ?></a></div>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-12 margin20">
					...
					<div class="row">
						...
						<div class="col-6">
							<a title="<?php echo $dizi["baslik"]; ?>" href="<?php echo base_url(); ?><?php echo $dizi["seo_adi"]; ?>"><img alt="<?php echo $dizi["banner_1_alt"]; ?>" title="<?php echo $dizi["banner_1_title"]; ?>" class="sl0 shadow" width="100%" src="<?php echo base_url(); ?>assets/resimler/<?php echo $dizi["banner_1"]; ?>"></a>
							<div class="nw1">
								<a title="<?php echo $dizi["baslik"]; ?>" href="<?php echo base_url(); ?><?php echo $dizi["seo_adi"]; ?>"><?php echo $dizi["baslik"]; ?></a></div>
				...
				<!--	<div class="col-lg-6 col-md-12 margin20">
						...
						<a title="<?php echo $dizi["baslik"]; ?>" href="<?php echo base_url(); ?><?php echo $dizi["seo_adi"]; ?>"><img alt="<?php echo $dizi["banner_2_alt"]; ?>" title="<?php echo $dizi["banner_2_title"]; ?>" class="sl0 shadow" width="100%" src="<?php echo base_url(); ?>assets/resimler/<?php echo $dizi["banner_2"]; ?>"></a>
						<div class="nw1">
							<a title="<?php echo $dizi["baslik"]; ?>" href="<?php echo base_url(); ?><?php echo $dizi["seo_adi"]; ?>"><?php echo $dizi["baslik"]; ?></a></div>
							<div class="bold margin5"><?php $tr=explode(" ",$dizi["tarih"]); $tr=explode("-",$tr[0]); echo $tr[2]."/".$tr[1]."/".$tr[0]; ?></div>
