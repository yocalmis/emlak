			...
			<div class="col-lg-9 col-md-7 col-sm-12 mx-auto margin30">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 col-6 mx-auto">
						<a   title="<?php echo $dizi[0]["proje_adi"]; ?>" href="<?php echo base_url(); ?><?php echo $dizi[0]["seo_adi"]; ?>">
							<div class="f1">
								...
								<div class="f3">
									...
									<?php echo $dizi[0]["min_fiyat"]*$this->session->userdata('para_birim'); ?>   <i class="fa-solid <?php echo $this->session->userdata('para_icon'); ?>"></i>
									
									</div><div class="temiz"></div>
									<div class="f3-2"><?php echo $dizi[0]["proje_yeri"]; ?></div>
									<div class="f3-3" style="height:60px;"><?php echo $dizi[0]["proje_adi"];  ?></div>
								</div>
