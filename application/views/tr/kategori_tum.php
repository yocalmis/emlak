...
<head><meta http-equiv="Content-Type" content="text/html; charset=euc-jp">
 ...
 <?php if ($ayar): foreach ($ayar as $dizi):
         $desc=$dizi["proje_description"];
         $tit=$dizi["proje_title"];		 
 endforeach; endif;   ?> 
...
<header class="header2">
	...
	<div class="container">
      ...
      <div class="row margin10"><div class="col-12 bld"><a class="bld" href="<?php echo base_url();?>"><?php echo $this->session->userdata('bread_ana'); ?></a> / <?php echo $this->session->userdata('bread_projects'); ?>   </div></div>
...
<?php for($n=2; $n<=$page; $n++){  if($n==$this->uri->segment(2)){ ?>
                  <li class="page-item active">
                    <a class="page-link" href="<?php echo base_url(); ?><?php echo "projects"; ?>/<?php echo $n; ?>"><?php echo $n; ?></a>
                  </li>
