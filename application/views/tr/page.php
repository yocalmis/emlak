...
<header class="header2">
	...
	<div class="container">
	  ...
	  <?php if($prop=="villa"){ ?><a class="bld" href="<?php echo base_url();?>villa"><?php echo $this->session->userdata('menu_10'); ?></a> <?php } ?>
	  <?php if($prop=="arsa"){ ?><a class="bld" href="<?php echo base_url();?>arsa"><?php echo $this->session->userdata('menu_12'); ?></a> <?php } ?>
	  <?php if($prop=="daire"){ ?><a class="bld" href="<?php echo base_url();?>arsa"><?php echo $this->session->userdata('menu_9'); ?></a> <?php } ?>
