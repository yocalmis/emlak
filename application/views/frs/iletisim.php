...
<header class="header2">
  ...
  <div class="container">
    ...
    <div class="row"><div class="hi1 mx-auto"><?php echo $this->session->userdata('real_est'); ?></div></div>
      <div class="row margin10"><div class="col-12 bld"><a class="bld" href="<?php echo base_url(); ?>frs/"><?php echo $this->session->userdata('bread_ana'); ?></a> / <?php echo $this->session->userdata('bread_iletisim'); ?> </div></div>
        ...
        <div class="row shadow i2">
          <div class="col-lg-6 col-md-12 col-sm-12 margin30">        <div class="tel1"><img alt="" class="mb1" src="<?php echo base_url(); ?>assets_user/tr/img/i2.png"></div>
            <div class="tel2">
              ...
              <div class="itel3"><?php echo $dizi["tel_1_frs"]; ?></div>
            </div></div>
