...
<header class="header2">
	...
	<div class="container">
      ...
      <div class="row margin10"><div class="col-12 bld"><a class="bld" href="<?php echo base_url(); ?>frs/"><?php echo $this->session->userdata('bread_ana'); ?></a> / <?php echo $this->session->userdata('bread_projects'); ?>   </div></div>
		...
		<div class="row ">
			...
			<!--<div class="col-lg-3 col-md-5 col-sm-12 mx-auto margin30">
				...
				<div class="lst shadow">
					...
					<li style="font-size:17px; font-weight: 700"> <i class="fa fa-angle-right" aria-hidden="true"></i><a title="<?php echo $dizi["kategori_adi_frs"]; ?>" href="<?php echo $dizi["seo_adi"]; ?>"><?php echo $dizi["kategori_adi_frs"]; ?></a></li>
					
					 	   <?php       if ($alt_kat [$n]): foreach ($alt_kat[$n] as $dizi2): ?> 
					<li style="font-size:17px; font-weight: 700"> <i class="fa fa-angle-right" aria-hidden="true"></i><a  title="<?php echo $dizi2["kategori_adi_frs"]; ?>" href="<?php echo $dizi2["seo_adi"]; ?>"><?php echo $dizi2["kategori_adi_frs"]; ?></a></li><br>
...
<?php for($n=2; $n<=$page; $n++){  if($n==$this->uri->segment(2)){ ?>
                  <li class="page-item active">
                    <a class="page-link" href="<?php echo base_url(); ?>frs/<?php echo "projects"; ?>/<?php echo $n; ?>"><?php echo $n; ?></a>
                  </li>
