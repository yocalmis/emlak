...
<header class="header2">
	...
	<div class="container">
		...
		<div class="row"><div class="hi1 mx-auto"><?php echo $this->session->userdata('real_est'); ?></div></div>
			   <?php       if ($kat_bilgi): foreach ($kat_bilgi as $dizi):  ?>  
      <div class="row margin10"><div class="col-12 bld"><a class="bld" href="<?php echo base_url(); ?>frs/"><?php echo $this->session->userdata('bread_ana'); ?></a> / <a class="bld" href="<?php echo base_url(); ?>frs/projects"><?php echo $this->session->userdata('bread_projects'); ?></a>  / <?php echo strtoupper($dizi["kategori_adi_frs"]); ?> </div></div>
...
<section>
	...
	<div class="container">
		...
		<div class="row margin60">
			<div class="col-12">
			<h1 class="font16 bold"><?php echo $this->session->userdata('kat_baslik_alan_1'); ?>  <?php echo $this->session->userdata('kat_baslik_alan_2'); ?> <?php echo strtoupper($dizi["kategori_adi_frs"]); ?></h1>
			<p><?php echo $dizi["kategori_on_yazi_frs"]; ?></p>
		</div>
		</div>
		...
		<div class="collapse" id="collapseExample">
		  <div class="card card-body">
		    <p><?php echo $dizi["kategori_aciklama_frs"]; ?></p>
		  </div>
		</div>
  ...
  content: '- Show Less -';
		...
		<div class="row ">
			...
			<div class="col-lg-3 col-md-5 col-sm-12 mx-auto margin30">
				...
				<li style="font-size:17px; font-weight: 700"> <i class="fa fa-angle-right" aria-hidden="true"></i><a  title="<?php echo $dizi2["kategori_adi_frs"]; ?>" href="<?php echo base_url(); ?>frs/<?php echo $dizi2["seo_adi"]; ?>"><?php echo $dizi2["kategori_adi_frs"]; ?></a></li><br>
						   <?php 	   endforeach;endif;  ?>
						...
						<a  title="<?php echo $dizi["proje_adi_frs"]; ?>" href="<?php echo base_url(); ?>frs/<?php echo $dizi["seo_adi"]; ?>">
							<div class="f1">
								...
								<div class="f3">
									...
									<div class="f3-3" style="height:60px;"><?php echo $dizi["proje_adi_frs"];  ?>
								<?php  
