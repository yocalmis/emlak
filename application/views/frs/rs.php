...
<header class="header2">
	...
	<div class="container">
      ...
      <div class="row margin10"><div class="col-12 bld"><a class="bld" href="<?php echo base_url();?>"><?php echo $this->session->userdata('bread_ana'); ?></a>  / 
	  
	  	  <?php if($prop=="rent"){ ?><a class="bld" href="<?php echo base_url(); ?>frs/rent"><?php echo $this->session->userdata('menu_7'); ?></a> <?php } ?>
	  <?php if($prop=="sale"){ ?><a class="bld" href="<?php echo base_url(); ?>frs/sale"><?php echo $this->session->userdata('menu_8'); ?></a> <?php } ?>
						...
						<a  title="<?php echo $dizi["proje_adi_frs"]; ?>" href="<?php echo base_url(); ?>frs/<?php echo $dizi["seo_adi"]; ?>">
							<div class="f1">
								...
								<div class="f3">
									...
									<div class="f3-3" style="height:60px;"><?php echo $dizi["proje_adi_frs"];  ?> <?php  
