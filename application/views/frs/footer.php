  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-3 col-6">
        <ul class="bold fomen">
        <li><a title="en" href="<?php echo base_url(); ?>frs/"><?php echo $this->session->userdata('home'); ?></a></li>
        <li><a  title="ABOUT" href="<?php echo base_url(); ?>frs/about"><?php echo $this->session->userdata('menu_2'); ?></a></li>
