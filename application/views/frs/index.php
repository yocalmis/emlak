						...
						<div class="col-lg-2 col-md-6 col-sm-6">
							<div class="czg">
								<select class="ktlist11" name="yer" id="yer" >
									...
									$varmi=array_search($dizi["unite_adi_frs"],$sira);
									if($varmi!=""){ 
				...
				<div class="col-lg-3 col-md-6 col-sm-6 col-6 mx-auto"><a title="<?php echo $dizi["proje_adi_frs"]; ?>" href="<?php echo base_url(); ?>frs/<?php echo $dizi["seo_adi"]; ?>">
					<div class="f11 shadow">
						...
						<div class="f3">
							...
							<div class="f3-3" style="height:60px;"><?php echo $dizi["proje_adi_frs"];  ?></div>
						</div>
					</div></a>
				</div>
	...
	<?php   if ($servis): foreach ($servis as $dizi): ?> 
		<div class="col-lg-3 col-md-6 col-sm-6 mx-auto margin30">
			...
			<div class="centerservices">
				...
				<h5><?php echo $dizi["alan_1_baslik_frs"]; ?></h5>
				<p> <?php echo $dizi["alan_1_yazi_frs"]; ?> </p>
		...
		<div class="col-lg-3 col-md-6 col-sm-6 mx-auto margin30">
			...
			<div class="centerservices">
				...
				<h5><?php echo $dizi["alan_2_baslik_frs"]; ?></h5>
				<p> <?php echo $dizi["alan_2_yazi_frs"]; ?> </p>
		...
		<div class="col-lg-3 col-md-6 col-sm-6 mx-auto margin30">
			...
			<div class="centerservices">
				...
				<h5><?php echo $dizi["alan_3_baslik_frs"]; ?></h5>
				<p> <?php echo $dizi["alan_3_yazi_frs"]; ?>  </p>
		...
		<div class="col-lg-3 col-md-6 col-sm-6 mx-auto margin30">
			...
			<div class="centerservices">
				...
				<h5><?php echo $dizi["alan_4_baslik_frs"]; ?></h5>
				<p> <?php echo $dizi["alan_4_yazi_frs"]; ?> </p>
			...
			<?php   if ($manset_proje): foreach ($manset_proje as $dizi): ?> 
				...
				<div class="col-lg-3 col-md-6 col-sm-6 col-6 mx-auto margin30"><a title="<?php echo $dizi["kategori_adi_frs"]; ?>" href="<?php echo base_url(); ?>frs/<?php echo $dizi["seo_adi"]; ?>">
					<div class="il1 shadow">
						...
						<div class="il2"><?php echo $dizi["kategori_adi_frs"]; ?></div>
					</div>
				</a>
			</div>
				...
				<div class="carousel-item <?php echo $c; ?>">
					...
					<div class="carousel-caption">
						<div class="sl2">
							...
							<h2><?php echo $dizi["kim_frs"]; ?></h2>
							<div class="sl2-2"><?php echo $dizi["yer_frs"]; ?></div>
							<p class="kpt"><?php echo $dizi["yazi_frs"]; ?></p>
						</div>
					</div>
		...
		<div class="row margin20">
			...
			<?php  if ($yeni_proje): foreach ($yeni_proje as $dizi): ?>  
				...
				<div class="col-lg-3 col-md-6 col-sm-6 col-6 mx-auto margin20">
					...
					<a title="<?php echo $dizi["proje_adi_frs"]; ?>" href="<?php echo base_url(); ?>frs/<?php echo $dizi["seo_adi"]; ?>"><img alt="<?php echo $dizi["banner_2_alt"]; ?>" title="<?php echo $dizi["banner_2_title"]; ?>" src="<?php echo base_url(); ?>assets/resimler/<?php echo $dizi["banner_2"]; ?>" width="100%" class="sl0 shadow"></a>
					<div class="ur1">
						<div class="ur1-1">
							<span class="bold"><?php echo $dizi["proje_yeri_frs"]; ?></span>
							<div class="ub1" style="height:70px;"><?php echo $dizi["proje_adi_frs"];?></div>
						</div>
						<div class="ur1-2">
							<div class="ur1-21"><?php echo $dizi["min_fiyat_frs"]; ?></div>
	...
	<section class="newsbg">
		...
		<div class="container">
			...
			<div class="row margin20">
				...
				<div class="col-3 tright margin15"><a class="all" href="<?php echo base_url(); ?>frs/news"><?php echo $this->session->userdata('ana_all_view'); ?></a></div>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-12 margin20">
					...
					<div class="row">
						...
						<div class="col-6">
							<a title="<?php echo $dizi["baslik_frs"]; ?>" href="<?php echo base_url(); ?>frs/<?php echo $dizi["seo_adi"]; ?>"><img alt="<?php echo $dizi["banner_1_alt"]; ?>" title="<?php echo $dizi["banner_1_title"]; ?>" class="sl0 shadow" width="100%" src="<?php echo base_url(); ?>assets/resimler/<?php echo $dizi["banner_1"]; ?>"></a>
							<div class="nw1">
								<a title="<?php echo $dizi["baslik_frs"]; ?>" href="<?php echo base_url(); ?>frs/<?php echo $dizi["seo_adi"]; ?>"><?php echo $dizi["baslik_frs"]; ?></a></div>
								<div class="bold margin5"><?php echo $dizi["tarih_frs"]; ?></div>
				...
				<!--	<div class="col-lg-6 col-md-12 margin20">
						...
						<a title="<?php echo $dizi["baslik_frs"]; ?>" href="<?php echo base_url(); ?><?php echo $dizi["seo_adi"]; ?>"><img alt="<?php echo $dizi["banner_2_alt"]; ?>" title="<?php echo $dizi["banner_2_title"]; ?>" class="sl0 shadow" width="100%" src="<?php echo base_url(); ?>assets/resimler/<?php echo $dizi["banner_2"]; ?>"></a>
						<div class="nw1">
							<a title="<?php echo $dizi["baslik_frs"]; ?>" href="<?php echo base_url(); ?><?php echo $dizi["seo_adi"]; ?>"><?php echo $dizi["baslik"]; ?></a></div>
							<div class="bold margin5"><?php echo $dizi["tarih_frs"]; ?></div>
				...
				<div class="col-lg-6 col-md-12 margin20">
					...
					<div class="row">
						...
						<div class="col-6">
							<a title="<?php echo $dizi["baslik"]; ?>" href="<?php echo base_url(); ?>frs/<?php echo $dizi["seo_adi"]; ?>"><img alt="<?php echo $dizi["banner_1_alt"]; ?>" title="<?php echo $dizi["banner_1_title"]; ?>" class="sl0 shadow" width="100%" src="<?php echo base_url(); ?>assets/resimler/<?php echo $dizi["banner_1"]; ?>"></a>
							<div class="nw1">
								<a title="<?php echo $dizi["baslik"]; ?>" href="<?php echo base_url(); ?>frs/<?php echo $dizi["seo_adi"]; ?>"><?php echo $dizi["baslik"]; ?></a></div>
