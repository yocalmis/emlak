...
<header class="header2">
	...
	<div class="container">
		...
		<div class="row"><div class="hi1 mx-auto"><?php echo $this->session->userdata('real_est'); ?></div></div>
			   <?php       if ($kat_bilgi): foreach ($kat_bilgi as $dizi):  ?>  
      <div class="row margin10"><div class="col-12 bld"><a class="bld" href="<?php echo base_url(); ?>ar/"><?php echo $this->session->userdata('bread_ana'); ?></a> / <a class="bld" href="<?php echo base_url(); ?>ar/projects"><?php echo $this->session->userdata('bread_projects'); ?></a>  / <?php echo strtoupper($dizi["kategori_adi_ar"]); ?> </div></div>
  ...
  content: '- Show Less -';
		...
		<div class="row ">
			...
			<div class="col-lg-3 col-md-5 col-sm-12 mx-auto margin30">
				...
				<li style="font-size:17px; font-weight: 700"> <i class="fa fa-angle-right" aria-hidden="true"></i><a  title="<?php echo $dizi2["kategori_adi_ar"]; ?>" href="<?php echo base_url(); ?>ar/<?php echo $dizi2["seo_adi"]; ?>"><?php echo $dizi2["kategori_adi_ar"]; ?></a></li><br>
						   <?php 	   endforeach;endif;  ?>
						...
						<a  title="<?php echo $dizi["proje_adi_ar"]; ?>" href="<?php echo base_url(); ?>ar/<?php echo $dizi["seo_adi"]; ?>">
							<div class="f1">
								...
								<div class="f3">
									...
									<div class="f3-3" style="height:60px;"><?php echo $dizi["proje_adi_ar"];  ?>
								<?php  
	...
	<?php  if($page>0){ ?>
                ...
                <ul class="pagination">
<?php for($n=2; $n<=$page; $n++){  if($n==$this->uri->segment(2)){ ?>
                  <li class="page-item active">
                    <a class="page-link" href="<?php echo base_url(); ?><?php echo $prop; ?>/<?php echo $n; ?>"><?php echo $n; ?></a>
                  </li>
