...
<header class="header2">
	...
	<div class="container">
		...
		<div class="row margin60">
			<div class="hi01 mx-auto"><h3 style="color:#fff; font-weight: 100; letter-spacing: 2px;"><?php echo $this->session->userdata('arama_manset'); ?></h3></div>
		</div>
		<div class="row"><div class="hi1 mx-auto"><?php echo $this->session->userdata('real_est'); ?></div></div>
      <div class="row margin10"><div class="col-12 bld"><a class="bld" href="<?php echo base_url();	  ?>"><?php echo $this->session->userdata('bread_ana'); ?></a> / <?php echo $this->session->userdata('arama_search'); ?>  </div></div>
...
<form action="<?php echo base_url(); ?>search" method="POST">
					<select   name="kat" class="ktlist1 margin20">
...
<?php 		$n=0; if ($proje_kat_tum): foreach ($proje_kat_tum as $dizi):
		...
		$n=$n+1; endforeach;endif;   ?>
		            ...
		            <select  onchange="myFunctions()" name="tip" id="tip" class="ktlist1 margin5">				
...
<br><br>
		            <select class="ktlist1 margin5" name="yer" id="yer">
...
$n=0; if ($proje_yeri): foreach ($proje_yeri as $dizi):
		...
		$n=$n+1; endforeach;endif;   ?>
		            ...
		            <select id="oz" class="ktlist1 margin5"  name="oz" >
...
<option selected value="<?php echo $oz; ?>"><?php echo $oz_adi; ?></option>	
	<?php	}	   ?>
              ...
              <div class="margin20"><input type="submit" class="btn btnkt2" value="<?php echo $this->session->userdata('search_6'); ?>"></div>
			...
			<div class="col-lg-9 col-md-7 col-sm-12 mx-auto margin30">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 col-6 mx-auto">
						<a   title="<?php echo $dizi[0]["proje_adi_ar"]; ?>" href="<?php echo base_url(); ?>ar/<?php echo $dizi[0]["seo_adi"]; ?>">
							<div class="f1">
								...
								<div class="f3">
									<div class="f3-1"><?php echo $dizi[0]["min_fiyat_ar"]; ?></div><div class="temiz"></div>
									<div class="f3-2"><?php echo $dizi[0]["proje_yeri_ar"]; ?></div>
									<div class="f3-3" style="height:60px;"><?php echo $dizi[0]["proje_adi_ar"];  ?></div>
								</div>
