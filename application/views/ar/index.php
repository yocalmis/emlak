...
<head><meta charset="euc-jp">
	...
	<?php  if ($ayar): foreach ($ayar as $dizi):
		$desc=$dizi["anasayfa_description_ar"];
		$tit=$dizi["anasayfa_title_ar"];		 
	endforeach; endif;   ?> 
		...
		<div class="container">
			...
			<div class="row margin60">
				<div class="hi0 mx-auto"><h1 style="color:#fff; font-weight: 100; letter-spacing: 2px;">
					<?php echo $this->session->userdata('ana_manset'); ?>   
				</h1></div>
			</div>
			<div class="row"><div class="hi1 mx-auto"><?php echo $this->session->userdata('real_est'); ?></div></div>
			<form action="<?php echo base_url(); ?>ar/search" method="POST">
				<div class="row margin70"><div class="col-lg-2 col-md-3 col-sm-4"><div class="hsearch1"><?php echo $this->session->userdata('search_1'); ?></div></div></div>
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="czg">
								<select name="kat" class="ktlist11">
									...
									echo'<option  value='.$dizi["kategori_id"].'>'.$dizi["kategori_adi_ar"].'</option>';
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="czg">
								<select onchange="myFunctions()" name="tip" id="tip"  class="ktlist11">
									...
									echo'<option value='.$dizi["proje_tip_id"].'>'.$dizi["tip_adi_ar"].'</option>';
									$n=$n+1; endforeach;endif;   ?>
								</select>
							</div>
						...
						<div class="col-lg-2 col-md-6 col-sm-6">
							<div class="czg">
								<select class="ktlist11" name="yer" id="yer" >
									...
									$varmi=array_search($dizi["unite_adi_ar"],$sira);
									if($varmi!=""){ 
										echo'<option  value='.$dizi["unite_tip_id"].'>'.$dizi["unite_adi"].'</option>';	
									}	
	...
	<div class="carousel-inner">
		<div class="carousel-item active">
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 col-sm-6 col-6 mx-auto"><a title="<?php echo $dizi["proje_adi_ar"]; ?>" href="<?php echo base_url(); ?>ar/<?php echo $dizi["seo_adi"]; ?>">
					<div class="f11 shadow">
						...
						<div class="f3">
							...
							<div class="f3-3" style="height:60px;"><?php echo $dizi["proje_adi_ar"];  ?></div>
						</div>
					</div></a>
				</div>
	...
	<?php   if ($servis): foreach ($servis as $dizi): ?> 
		<div class="col-lg-3 col-md-6 col-sm-6 mx-auto margin30">
			...
			<div class="centerservices">
				...
				<h5><?php echo $dizi["alan_1_baslik_ar"]; ?></h5>
				<p> <?php echo $dizi["alan_1_yazi_ar"]; ?> </p>
		...
		<div class="col-lg-3 col-md-6 col-sm-6 mx-auto margin30">
			...
			<div class="centerservices">
				...
				<h5><?php echo $dizi["alan_2_baslik_ar"]; ?></h5>
				<p> <?php echo $dizi["alan_2_yazi_ar"]; ?> </p>
		...
		<div class="col-lg-3 col-md-6 col-sm-6 mx-auto margin30">
			...
			<div class="centerservices">
				...
				<h5><?php echo $dizi["alan_3_baslik_ar"]; ?></h5>
				<p> <?php echo $dizi["alan_3_yazi_ar"]; ?>  </p>
		...
		<div class="col-lg-3 col-md-6 col-sm-6 mx-auto margin30">
			...
			<div class="centerservices">
				...
				<h5><?php echo $dizi["alan_4_baslik_ar"]; ?></h5>
				<p> <?php echo $dizi["alan_4_yazi_ar"]; ?> </p>
...
<section class="newsbg">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-9"><h3 class="bold"><?php echo $this->session->userdata('menu_13'); ?></h3></div>
		<!--	<div class="col-3 tright margin15"><a class="all" href="apart"><?php echo $this->session->userdata('ana_all_view'); ?></a></div>	
-->
		...
		<div class="row">
			<?php   if ($manset_proje): foreach ($manset_proje as $dizi): ?> 
				...
				<div class="col-lg-3 col-md-6 col-sm-6 col-6 mx-auto margin30"><a title="<?php echo $dizi["kategori_adi_ar"]; ?>" href="<?php echo base_url(); ?>ar/<?php echo $dizi["seo_adi"]; ?>">
					<div class="il1 shadow">
						...
						<div class="il2"><?php echo $dizi["kategori_adi_ar"]; ?></div>
					</div>
				</a>
			</div>
		...
		<div class="col-12">
			...
			<div class="carousel-inner" role="listbox">
				...
				<div class="carousel-item <?php echo $c; ?>">
					<div class="view">
						<img class="d-block w-100" alt="<?php echo $dizi["resim_alt"]; ?>" title="<?php echo $dizi["resim_title"]; ?>" src="<?php echo base_url(); ?>assets/resimler/<?php echo $dizi["resim"]; ?>" alt="First slide">
						<div class="mask rgba-black-light"></div>
					</div>
					<div class="carousel-caption">
						<div class="sl2">
							<span class="sl2-1">SALES</span>
							<h2><?php echo $dizi["kim_ar"]; ?></h2>
							<div class="sl2-2"><?php echo $dizi["yer_ar"]; ?></div>
							<p class="kpt"><?php echo $dizi["yazi_ar"]; ?></p>
						</div>
					</div>
...
<section>
	...
	<div class="container">
		...
		<div class="row margin50"><div class="col-12 center"><h3 class="bold"><?php echo $this->session->userdata('ana_new_eml'); ?></h3> <span class="lbalt"><?php echo $this->session->userdata('ana_new_prj_yazi'); ?></span>  </div></div>
		...
		<div class="row margin20">
			...
			<?php  if ($yeni_proje): foreach ($yeni_proje as $dizi): ?>  
				...
				<div class="col-lg-3 col-md-6 col-sm-6 col-6 mx-auto margin20">
					...
					<a title="<?php echo $dizi["proje_adi_ar"]; ?>" href="<?php echo base_url(); ?>ar/<?php echo $dizi["seo_adi"]; ?>"><img alt="<?php echo $dizi["banner_2_alt"]; ?>" title="<?php echo $dizi["banner_2_title"]; ?>" src="<?php echo base_url(); ?>assets/resimler/<?php echo $dizi["banner_2"]; ?>" width="100%" class="sl0 shadow"></a>
					<div class="ur1">
						<div class="ur1-1">
							<span class="bold"><?php echo $dizi["proje_yeri_ar"]; ?></span>
							<div class="ub1" style="height:70px;"><?php echo $dizi["proje_adi_ar"];?></div>
						</div>
						<div class="ur1-2">
							<div class="ur1-21"><?php echo $dizi["min_fiyat_ar"]; ?></div>
	...
	<section class="newsbg">
		...
		<div class="container">
			...
			<div class="row margin20">
				<div class="col-9"><h3 class="bold"><?php echo $this->session->userdata('menu_4'); ?></h3></div>
				<div class="col-3 tright margin15"><a class="all" href="<?php echo base_url(); ?>ar/news"><?php echo $this->session->userdata('ana_all_view'); ?></a></div>
			...
			<div class="row">
					...
					<div class="row">
						...
						<div class="col-6">
							...
							<div class="nw1">
								...
								<div class="bold margin5"><?php echo $dizi["tarih_ar"]; ?></div>
				...
				<!--	<div class="col-lg-6 col-md-12 margin20">
						...
						<a title="<?php echo $dizi["baslik_ar"]; ?>" href="<?php echo base_url(); ?><?php echo $dizi["seo_adi"]; ?>"><img alt="<?php echo $dizi["banner_2_alt"]; ?>" title="<?php echo $dizi["banner_2_title"]; ?>" class="sl0 shadow" width="100%" src="<?php echo base_url(); ?>assets/resimler/<?php echo $dizi["banner_2"]; ?>"></a>
						<div class="nw1">
							<a title="<?php echo $dizi["baslik_ar"]; ?>" href="<?php echo base_url(); ?><?php echo $dizi["seo_adi"]; ?>"><?php echo $dizi["baslik"]; ?></a></div>
							<div class="bold margin5"><?php echo $dizi["tarih_ar"]; ?></div>
				...
				<div class="col-lg-6 col-md-12 margin20">
					...
					<div class="row">
						...
						<?php $n=0; if ($kat_haber_manset_3): foreach ($kat_haber_manset_3 as $dizi): ?> 


						<div class="col-6">
							<a title="<?php echo $dizi["baslik"]; ?>" href="<?php echo base_url(); ?>ar/<?php echo $dizi["seo_adi"]; ?>"><img alt="<?php echo $dizi["banner_1_alt"]; ?>" title="<?php echo $dizi["banner_1_title"]; ?>" class="sl0 shadow" width="100%" src="<?php echo base_url(); ?>assets/resimler/<?php echo $dizi["banner_1"]; ?>"></a>
							<div class="nw1">
								<a title="<?php echo $dizi["baslik"]; ?>" href="<?php echo base_url(); ?>ar/<?php echo $dizi["seo_adi"]; ?>"><?php echo $dizi["baslik"]; ?></a></div>
					...
					<div class="row margin70">
						...
						<div class="col-lg-4 col-12 mx-auto">
							<div class="shadow cl1">
								...
								</h5><p>        <?php echo $this->session->userdata('call_center_aciklama'); ?>
							</p>  </div>
							<?php       if ($ayar): foreach ($ayar as $dizi): ?>  
