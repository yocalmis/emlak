...
<header class="header2">
 ...
 <?php echo $this->session->userdata('about_manset_yazi'); ?>   
	  </h3></div>
    </div>
    <div class="row"><div class="hi1 mx-auto"><?php echo $this->session->userdata('real_est'); ?></div></div>
      <div class="row margin10"><div class="col-12 bld"><a class="bld" href="<?php echo base_url(); ?>ar/"><?php echo $this->session->userdata('bread_ana'); ?></a> / <?php echo $this->session->userdata('bread_abo'); ?> </div></div>
  </div>
...
<section>
  ...
  <div class="container">
    ...
    <div class="row margin30">
      <div class="col-12"><span class="font15 bold"> <h1 class="font15 bold">  <?php echo $dizi["baslik_ar"]; ?> </h1></span>
