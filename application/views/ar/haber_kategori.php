...
<?php echo $this->session->userdata('haber_manset_yazi'); ?>
      ...
      <div class="row margin10"><div class="col-12 bld"><a class="bld" href="<?php echo base_url(); ?>ar/"><?php echo $this->session->userdata('bread_ana'); ?></a> /  <?php if($prop!=""){ ?> <a class="bld" href="<?php echo base_url(); ?>ar/news"><?php } ?><?php echo $this->session->userdata('bread_news'); ?><?php if($prop!=""){ ?></a><?php } ?><?php if($prop!=""){ ?> / <?php echo strtoupper($haber_kat_adi); ?> <?php } ?> </div></div>
...
<div class="container">
		...
		<div class="row">
				...
				<div class="lst shadow">
					...
					<li style="font-size:17px; font-weight: 700"> <i class="fa fa-angle-right" aria-hidden="true"></i> <a  title="<?php echo $dizi["kategori_adi_ar"]; ?>" href="<?php echo base_url(); ?>ar/<?php echo $dizi["seo_adi"]; ?>"><?php echo $dizi["kategori_adi_ar"]; ?></a></li>
					<?php  	   endforeach;endif;  ?> 
				<!--	<li style="font-size:17px; font-weight: 700"> <i class="fa fa-angle-right" aria-hidden="true"></i> <a  title="BUYER GUIDE" href="<?php echo base_url(); ?>ar/buyer_guide">Buyer Guide</a></li>
				-->	</ul> 		
		...
		<!--	<div class="col-lg-5 col-md-12 margin20">
				...
				<a  title="<?php echo $dizi["baslik_ar"]; ?>" href="<?php echo $dizi["seo_adi"]; ?>"><img alt="<?php echo $dizi["banner_2_alt"]; ?>" title="<?php echo $dizi["banner_2_title"]; ?>" class="sl0 shadow" width="100%" src="<?php echo base_url(); ?>assets/resimler/<?php echo $dizi["banner_2"]; ?>"></a>
				<div class="nw1">
							<a  title="<?php echo $dizi["baslik_ar"]; ?>" href="<?php echo $dizi["seo_adi"]; ?>"><?php echo $dizi["baslik_ar"]; ?></a></div>
						<div class="bold margin5"><?php $tr=explode(" ",$dizi["tarih_ar"]); $tr=explode("-",$tr[0]); echo $tr[2]."/".$tr[1]."/".$tr[0]; ?></div>
					<?php $n=$n+1; endforeach;endif;  ?>	
			</div>
		-->	
