 ...
 <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
          <a class="navbar-brand" href="<?php echo base_url(); ?>ar">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown">
                 ...
                 <span class="nav-link-inner--text"><?php echo $this->session->userdata('menu_13'); ?> <i style="font-size:15px; color:#fff; margin-left:4px; margin-top:-5px !important;" class="fa fa-sort-desc" aria-hidden="true"></i></span>
				   ...
				   <?php       if ($proje_kat): foreach ($proje_kat as $dizi): ?>  
	                <a title="" href="<?php echo base_url(); ?>ar/<?php echo $dizi["seo_adi"]; ?>" class="dropdown-item"><?php echo $dizi["kategori_adi"]; ?></a>
					<?php  	   endforeach;endif;  ?>    
			           ...
			           <li class="nav-item">
                <a title="" class="nav-link " href="<?php echo base_url(); ?>ar/projects"><?php echo $this->session->userdata('ana_prj'); ?></a>
              </li>
              ...
              <li class="nav-item dropdown">
                 ...
                 <span class="nav-link-inner--text"><?php echo $this->session->userdata('menu_7'); ?> <i style="font-size:15px; color:#fff; margin-left:4px; margin-top:-5px !important;" class="fa fa-sort-desc" aria-hidden="true"></i></span>
	               ...
	               <div class="dropdown-menu">
	                <a title="" href="<?php echo base_url(); ?>ar/rent" class="dropdown-item"><?php echo $this->session->userdata('menu_7'); ?></a>				   
	                <a title="" href="<?php echo base_url(); ?>ar/sale" class="dropdown-item"><?php echo $this->session->userdata('menu_8'); ?></a>				   
                ...
                <li class="nav-item">
                <a title="" class="nav-link " href="<?php echo base_url(); ?>ar/daire"><?php echo $this->session->userdata('menu_9'); ?></a>
              </li>
			  
	                <li class="nav-item">
                <a title="" class="nav-link " href="<?php echo base_url(); ?>ar/villa"><?php echo $this->session->userdata('menu_10'); ?></a>
              </li>
...
-->
                ...
                <li class="nav-item">
                <a title="" class="nav-link " href="<?php echo base_url(); ?>ar/arsa"><?php echo $this->session->userdata('menu_12'); ?></a>
              </li>			  
              ...
              <li class="nav-item">
                <a title="" class="nav-link " href="<?php echo base_url(); ?>ar/about"><?php echo $this->session->userdata('menu_2'); ?></a>
              </li>
              ...
              <li class="nav-item">
                <a title="" class="nav-link " href="<?php echo base_url(); ?>ar/news"><?php echo $this->session->userdata('menu_4'); ?></a>
              </li>


              <li class="nav-item">
                <a title="" class="nav-link" href="<?php echo base_url(); ?>ar/contact"><?php echo $this->session->userdata('menu_5'); ?></a>
              </li>
            ...
            <li class="nav-item dropdown">
              <a href="<?php echo base_url(); ?>ar/projects" class="nav-link" data-toggle="dropdown" href="#" role="button">
                 <span class="nav-link-inner--text dil2">TURKISH <i style="font-size:15px; color:#000; margin-left:4px; margin-top:-18px !important;" class="fa fa-sort-desc" aria-hidden="true"></i></span>
              </a>
              <div class="dropdown-menu">
