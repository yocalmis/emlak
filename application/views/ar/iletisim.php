...
<header class="header2">
  ...
  <div class="container">
    ...
    <div class="row"><div class="hi1 mx-auto"><?php echo $this->session->userdata('real_est'); ?></div></div>
      <div class="row margin10"><div class="col-12 bld"><a class="bld" href="<?php echo base_url(); ?>ar/"><?php echo $this->session->userdata('bread_ana'); ?></a> / <?php echo $this->session->userdata('bread_iletisim'); ?> </div></div>
    ...
    <div class="row margin30">
      <div class="col-lg-6 col-md-6 col-sm-12 mx-auto margin60">
        ...
        <div class="row shadow i2">
          <div class="col-lg-6 col-md-12 col-sm-12 margin30">        <div class="tel1"><img alt="" class="mb1" src="<?php echo base_url(); ?>assets_user/tr/img/i2.png"></div>
            <div class="tel2">
              <span class="tel3-1"><?php echo $this->session->userdata('phone_number'); ?></span>
              <div class="itel3"><?php echo $dizi["tel_1_ar"]; ?></div>
            </div></div>
          <div class="col-lg-6 col-md-12 col-sm-12 margin30">
            
                    <div class="tel1"><img alt="" src="<?php echo base_url(); ?>assets_user/tr/img/wht.png" class="mb1" width="auto"></div>
            <div class="tel2">
              <span class="tel3-1"><?php echo $this->session->userdata('whatsapp_help'); ?></span>
              <div class="itel3"><?php echo $dizi["whatsapp"]; ?></div>
            </div>
              ...
              <div class="row margin50">
                ...
                <div class="col-10"><?php echo $dizi["adress_ar"]; ?></div>
              </div>

              <div class="row margin30">
                <div class="col-1"><img alt="" height="18" src="<?php echo base_url(); ?>assets_user/tr/img/tel.png"></div>
                <div class="col-10"><?php echo $dizi["tel_1_ar"]; ?></div>
              </div>

              <div class="row margin30">
                <div class="col-1"><img alt="" height="18" src="<?php echo base_url(); ?>assets_user/tr/img/cep.png"></div>
                <div class="col-10"><?php echo $dizi["whatsapp_ar"]; ?></div>
              </div>

              <div class="row margin30">
                <div class="col-1"><img alt="" height="19" width="auto" src="<?php echo base_url(); ?>assets_user/tr/img/mail.png"></div>
                <div class="col-10"><?php echo $dizi["email"]; ?></div>
              </div>

                
              <div class="row margin10">
                <div class="col-12">
                  <img alt="" style="float:left;" src="<?php echo base_url(); ?>assets_user/ls/b1.png"> 
				  <img alt="" style="float:left;" src="<?php echo base_url(); ?>assets_user/ls/b2.png"> 
				  <!--<img alt="" style="float:left;" src="<?php echo base_url(); ?>assets_user/ls/b3.png">
				  <img alt="" style="float:left;" src="<?php echo base_url(); ?>assets_user/ls/b4.png">
				  <img alt="" style="float:left;" src="<?php echo base_url(); ?>assets_user/ls/b5.png">
				  <img alt="" style="float:left;" src="<?php echo base_url(); ?>assets_user/ls/b6.png">--> 
                  <img alt="" style="float:left;" src="<?php echo base_url(); ?>assets_user/ls/b7.png">
                </div>
              </div>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-12 mx-auto margin60">
...
<option data-countryCode="GB" value="44" Selected>UK (+44)</option>
    ...
    <textarea placeholder="<?php echo $this->session->userdata('msg_5'); ?>" id="msg" class="inpt2 margin15"></textarea>
