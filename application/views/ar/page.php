...
<header class="header2">
	...
	<div class="container">
	  ...
	  <?php if($prop=="villa"){ ?><a class="bld" href="<?php echo base_url(); ?>ar/villa"><?php echo $this->session->userdata('menu_10'); ?></a> <?php } ?>
	  <?php if($prop=="arsa"){ ?><a class="bld" href="<?php echo base_url(); ?>ar/arsa"><?php echo $this->session->userdata('menu_12'); ?></a> <?php } ?>
	  <?php if($prop=="daire"){ ?><a class="bld" href="<?php echo base_url(); ?>ar/daire"><?php echo $this->session->userdata('menu_9'); ?></a> <?php } ?>
			...
			<div class="col-lg-9 col-md-7 col-sm-12 mx-auto margin30">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 col-6 mx-auto">
						<a  title="<?php echo $dizi["proje_adi"]; ?>" href="<?php echo base_url(); ?>ar/<?php echo $dizi["seo_adi"]; ?>">
							<div class="f1">
