			...
			<div class="col-lg-3 col-md-6 col-sm-6 col-6 mx-auto"><a title="<?php echo $dizi["proje_adi_ar"]; ?>" href="<?php echo base_url(); ?>ar/<?php echo $dizi["seo_adi"]; ?>">
				<div class="f11 shadow">
					...
					<div class="f3">
						...
						<div class="f3-3 tright" style="height:60px;"><?php echo $dizi["proje_adi_ar"];   ?></div>
					</div>
				</div></a>
			</div>
		...
		<div class="row kpt">
			...
			<div class="col-lg-3 col-md-6 col-sm-6 mx-auto margin30">
				...
				<div class="centerservices">
					...
					<h5 class=""><?php echo $dizi["alan_1_baslik_ar"]; ?></h5>
					<p class="tright"><?php echo $dizi["alan_1_yazi_ar"]; ?> </p>
				...
				<div class="centerservices">
					...
					<h5 class=""><?php echo $dizi["alan_2_baslik_ar"]; ?></h5>
					<p class="tright"><?php echo $dizi["alan_2_yazi_ar"]; ?> </p>
			...
			<div class="col-lg-3 col-md-6 col-sm-6 mx-auto margin30">
				...
				<div class="centerservices">
					...
					<h5 class=""><?php echo $dizi["alan_3_baslik_ar"]; ?></h5>
					<p class="tright"><?php echo $dizi["alan_3_yazi_ar"]; ?> </p>
			...
			<div class="col-lg-3 col-md-6 col-sm-6 mx-auto margin30">
				...
				<div class="centerservices">
					...
					<h5 class=""><?php echo $dizi["alan_4_baslik_ar"]; ?></h5>
					<p class="tright"><?php echo $dizi["alan_4_yazi_ar"]; ?> </p>
...
<section class="newsbg">
	...
	<div class="container">
		...
		<div class="row margin70">
		    <div class="col-3  margin15"><a class="all" href="ar/projects"><?php echo $this->session->userdata('ana_all_view'); ?></a></div>			    
		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-6 col-sm-6 col-6 mx-auto margin30"><a title="<?php echo $dizi["kategori_adi_ar"]; ?>" href="<?php echo base_url(); ?>ar/<?php echo $dizi["seo_adi"]; ?>">
				<div class="il1 shadow">
					...
					<div class="il2 tright"><?php echo $dizi["kategori_adi_ar"]; ?></div>
				</div>
				</a>
			</div>
      ...
      <div class="view">
        ...
        <div class="carousel-caption">
        	<div class="sl2">
				...
				<h2 class="tright"><?php echo $dizi["kim_ar"]; ?></h2>
				<div class="sl2-2 tright"><?php echo $dizi["yer_ar"]; ?></div>
				<p class="kpt tright"><?php echo $dizi["yazi_ar"]; ?></p>
			</div>
      </div>
	...
	<div class="container">
		...
		<div class="row margin20">
			...
			<div class="col-lg-3 col-md-6 col-sm-6 col-6 mx-auto margin20">
				<a title="<?php echo $dizi["proje_adi_ar"]; ?>" href="<?php echo base_url(); ?>ar/<?php echo $dizi["seo_adi"]; ?>">
				...
				<div class="ur1">
					...
					<div class="ur1-1 tright" style="float:right;">
						<span class="bold tright"><?php echo $dizi["proje_yeri_ar"]; ?></span>
						<div class="ub1 tright" style="height:70px;"><?php echo $dizi["proje_adi_ar"];  ?></div>
					</div>

					<div class="ur1-2" style="float:left;">
						<div class="ur1-21 tright"><?php echo $dizi["min_fiyat_ar"]; ?></div>
...
<section class="newsbg">
	...
	<div class="container">
		...
		<div class="row margin20">
			<div class="col-md-3 col-sm-4 col-5 margin15"><a class="all" href="ar/news"><?php echo $this->session->userdata('ana_all_view'); ?></a></div>
...
<option data-countryCode="GB" value="44" Selected>UK (+44)</option>
	...
	<optgroup label="Other countries">
      ...
      <div class="col-lg-4 col-12 mx-auto">
	   ...
	   <?php       if ($ayar): foreach ($ayar as $dizi): ?>  
          <div class="tel">
            <div class="tel1"><img style="margin-left:20px;" alt="" class="mb1" src="<?php echo base_url(); ?>assets_user/ar/img/i2.png"></div>
            <div class="tel2">
          ...
          <div class="wts margin20">
            <div class="tel1"><img style="margin-left:20px;" alt="" src="<?php echo base_url(); ?>assets_user/ar/img/wht.png" class="mb1" width="auto"></div>
            <div class="tel2">
  ...
  <script src="<?php echo base_url(); ?>assets_user/ar/js/pro.js?v=1.0.1"></script>
   <script src="<?php echo base_url(); ?>assets_user/ar/js/sel/select_un.js"></script> 
   <script src="<?php echo base_url(); ?>assets_user/ar/js/sel/select_oz.js"></script> 
    	<script>
