  ...
  <div class="container">
    <div class="row">
	   ...
	   <?php       if ($haber_kat): foreach ($haber_kat as $dizi): ?>  
        ...
        <li><a   title="AR" href="<?php echo base_url(); ?>ar"><?php echo $this->session->userdata('home'); ?></a></li>
        <li><a  title="ABOUT US" href="<?php echo base_url(); ?>ar/about"><?php echo $this->session->userdata('menu_2'); ?></a></li>
        <li><a  title="BUYER GUIDE" href="<?php echo base_url(); ?>ar/buyer_guide"><?php echo $this->session->userdata('menu_3'); ?></a></li>
