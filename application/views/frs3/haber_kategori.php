...
<div class="container">
		...
		<!--	<div class="col-lg-5 col-md-12 margin20">
				...
				<a  title="<?php echo $dizi["baslik"]; ?>" href="<?php echo $dizi["seo_adi"]; ?>"><img alt="<?php echo $dizi["banner_2_alt"]; ?>" title="<?php echo $dizi["banner_2_title"]; ?>" class="sl0 shadow" width="100%" src="<?php echo base_url(); ?>assets/resimler/<?php echo $dizi["banner_2"]; ?>"></a>
				<div class="nw1">
							<a  title="<?php echo $dizi["baslik"]; ?>" href="<?php echo $dizi["seo_adi"]; ?>"><?php echo $dizi["baslik"]; ?></a></div>
						<div class="bold margin5"><?php $tr=explode(" ",$dizi["tarih"]); $tr=explode("-",$tr[0]); echo $tr[2]."/".$tr[1]."/".$tr[0]; ?></div>
					<?php $n=$n+1; endforeach;endif;  ?>	
...
<?php if($page>0){ ?>
                ...
                <ul class="pagination">
                     <?php if($p>=2){ ?>   
                  <li class="page-item">
                    <a class="page-link" href="<?php echo base_url(); ?>news/<?php echo $p-1; ?>"><i class="fa fa-angle-left"></i></a>
                  </li><?php } ?> 
<?php for($n=2; $n<=$page; $n++){ ?>
                  <li class="page-item">
                    <a class="page-link" href="<?php echo base_url(); ?>news/<?php echo $n; ?>"><?php echo $n; ?></a>
                  </li>
<?php  } ?>				  <?php if($p<$page){ ?>  
                  <li class="page-item">
                    <a class="page-link" href="<?php echo base_url(); ?>news/<?php if($p==""){ echo $p+2; } else{echo $p+1; } ?>"><i class="fa fa-angle-right"></i></a>
                  </li><?php } ?> 
                </ul>
              </nav> 
