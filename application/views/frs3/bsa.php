...
<header class="header2">
  ...
  <div class="container">
    ...
    <div class="row"><div class="hi1 mx-auto">REAL ESTATE TURKEY</div></div>
      <div class="row margin10"><div class="col-12 bld"><a class="bld" href="">ANASAYFA</a> / <a class="bld" href="">ANASAYFA</a>  / <a class="bld" href="">ANASAYFA</a> </div></div>
...
<section>
	<div class="container">
		...
		<div class="row margin30">
			<div class="col-lg-6 col-md-12 mx-auto"><img alt="" width="100%" src="<?php echo base_url(); ?>assets_user/tr/img/bsa.png"></div>
			<div class="col-lg-6 col-md-12 mx-auto">
				...
				<div class="margin30 row shadow i2">
					<div class="col-lg-6 col-md-6 col-sm-12 margin30">				<div class="tel1"><img alt="" src="<?php echo base_url(); ?>assets_user/tr/img/i2.png"></div>
						<div class="tel2">
