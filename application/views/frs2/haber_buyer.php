...
<?php echo $this->session->userdata('haber_manset_yazi'); ?>
    ...
    <div class="row"><div class="hi1 mx-auto tright"><?php echo $this->session->userdata('real_est'); ?></div></div>
      <div class="row margin10"><div class="col-12 bld tright"><a class="bld" href="<?php echo base_url(); ?>frs"><?php echo $this->session->userdata('bread_ana'); ?></a> / <a class="bld" href="<?php echo base_url(); ?>frs/news"><?php echo $this->session->userdata('bread_news'); ?></a>  / <a class="bld" href="<?php echo base_url(); ?>frs/<?php echo $seo_adi; ?>"><?php echo strtoupper($kat); ?></a>  / <?php echo strtoupper($haber_buyer_adi); ?>  </div></div>
...
<section>
    ...
    <div class="row margin30">
            <div class="col-lg-2 col-md-12 mx-auto"><div class="ictrh"><?php echo $dizi["tarih_frs"]; ?></div></div>

      <div class="col-lg-10 col-md-12 mx-auto tright"><h1 style="font-size:22px; font-weight: 600">  <?php echo $dizi["baslik_frs"]; ?></h1></div>
