...
<footer>
  ...
  <div class="container">
    <div class="row">
        ...
        <ul class="fomen tright">
          <div class="bold fo1-1"><?php echo $this->session->userdata('footer_3'); ?></div>
	   <?php       if ($linkler): foreach ($linkler as $dizi): ?>  
	         <li>       <a   title="<?php echo $dizi["adi_frs"]; ?>"  href="<?php echo $dizi["link_frs"]; ?>"><?php echo $dizi["adi_frs"]; ?></a> </li>
        ...
        <li><a href="<?php echo base_url(); ?>buyer_guide"><?php echo $this->session->userdata('buyer_guide_kucuk'); ?></a></li>
	   <?php       if ($haber_kat): foreach ($haber_kat as $dizi): ?>  
	         <li>       <a   title="<?php echo $dizi["kategori_adi_frs"]; ?>" href="<?php echo base_url(); ?>frs/<?php echo $dizi["seo_adi"]; ?>"><?php echo $dizi["kategori_adi_frs"]; ?></a> </li>
					<?php  	   endforeach;endif;  ?>  
        </ul>
      </div>
        ...
        <div class="bold fo1-1"><?php echo $this->session->userdata('footer_1'); ?></div>
          ...
          <div class="col-lg-3 col-6">
        <ul class="bold fomen tright">
        <li><a   title="FR" href="<?php echo base_url(); ?>frs"><?php echo $this->session->userdata('home'); ?></a></li>
        <li><a  title="ABOUT US" href="<?php echo base_url(); ?>frs/about"><?php echo $this->session->userdata('menu_2'); ?></a></li>
        <li><a  title="BUYER GUIDE" href="<?php echo base_url(); ?>frs/buyer_guide"><?php echo $this->session->userdata('menu_3'); ?></a></li>
        <li><a  title="NEWS" href="<?php echo base_url(); ?>frs/news"><?php echo $this->session->userdata('menu_4'); ?></a></li>
        <li><a  title="CONTACT" href="<?php echo base_url(); ?>frs/contact"><?php echo $this->session->userdata('menu_5'); ?></a></li>
        </ul>
      </div>  
...
<div class="row">
  ...
  <div class="col-lg-9 col-md-8 col-sm-6 mx-auto margin20 ">@ 
<?php echo $this->session->userdata('footer_alt'); ?></div>
  <div class="col-lg-3 col-md-4 col-sm-6 mx-auto margin20 h50">
