...
<head><meta http-equiv="Content-Type" content="text/html; charset=euc-jp">
 ...
 <?php if ($hakkimizda): foreach ($hakkimizda as $dizi):
         $desc=$dizi["about_description_frs"];
         $tit=$dizi["about_title_frs"];		 
 endforeach; endif;  ?> 
...
<header class="header2">
  ...
  <div class="container">
    ...
    <div class="row"><div class="hi1 mx-auto tright"><?php echo $this->session->userdata('real_est'); ?></div></div>
      <div class="row margin10"><div class="col-12 bld tright"><a class="bld" href="<?php echo base_url(); ?>frs"><?php echo $this->session->userdata('bread_ana'); ?></a> / <?php echo $this->session->userdata('bread_abo'); ?> </div></div>
  ...
  <div class="container">
   ...
   <?php       if ($hakkimizda): foreach ($hakkimizda as $dizi): ?>   
    ...
    <div class="row margin30">
      <div class="col-12 tright"><span class="font15 bold"><h1 class="font15 bold"><?php echo $dizi["baslik_frs"]; ?></h1></span>
<p style="margin-top:20px"><?php echo $dizi["yazi_frs"]; ?>
</p>
      </div>
    ...
    <div class="row">
      <div class="col-md-6 col-sm-12 mx-auto margin40 tright">
        ...
        <p><?php echo $dizi["misyon_frs"]; ?></p></div>
      </div>
      <div class="col-md-6 col-sm-12 mx-auto margin40 tright"><div class="abt0">
        ...
        <p><?php echo $dizi["vizyon_frs"]; ?></p></div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-12 mx-auto margin20 tright">
        <div class="abt1">
          <span class="bold"><?php echo $dizi["alan_1_baslik_frs"]; ?></span><div class="temiz"></div>
      ...
      <div class="col-md-6 col-sm-12 mx-auto margin20 tright">
        <div class="abt1">
          <span class="bold"><?php echo $dizi["alan_2_baslik_frs"]; ?></span><div class="temiz"></div>
      ...
      <div class="col-md-6 col-sm-12 mx-auto margin20 tright">
        <div class="abt1">
          <span class="bold"><?php echo $dizi["alan_3_baslik_frs"]; ?></span><div class="temiz"></div>
      ...
      <div class="col-md-6 col-sm-12 mx-auto margin20 tright">
        <div class="abt1">
          <span class="bold"><?php echo $dizi["alan_4_baslik_frs"]; ?></span><div class="temiz"></div>
      ...
      <div class="col-12 margin20 tright">
        <div class="abt1">
          <span class="bold"><?php echo $dizi["alan_5_baslik_frs"]; ?></span><div class="temiz"></div>
          <p><?php echo $dizi["alan_5_yazi_frs"]; ?></p>
        </div>
      </div>
