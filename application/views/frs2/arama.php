...
<header class="header2">
	...
	<div class="container">
      ...
      <div class="row margin10"><div class="col-12 bld tright"><a class="bld" href="<?php echo base_url();	  ?>frs"><?php echo $this->session->userdata('bread_ana'); ?></a> / <?php echo $this->session->userdata('arama_search'); ?> </div></div>
			...
			<div class="col-lg-9 col-md-7 col-sm-12 mx-auto margin30">
				...
				<?php $n=0; if ($arama): foreach ($arama as $dizi): ?>  
					...
					<div class="col-lg-4 col-md-6 col-6 mx-auto">
						<a title="<?php echo $dizi[0]["proje_adi_frs"]; ?>" href="<?php echo base_url(); ?><?php echo $dizi[0]["seo_adi"]; ?>">
							<div class="f1">
								...
								<div class="f3">
									<div class="f3-1 tright"><?php echo $dizi[0]["min_fiyat_frs"]; ?></div><div class="temiz"></div>
									<div class="f3-2 tright"><?php echo $dizi[0]["proje_yeri_frs"]; ?></div>
									<div class="f3-3 tright" style="height:60px;"><?php echo $dizi[0]["proje_adi_frs"];  ?></div>
								</div>
