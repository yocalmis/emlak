...
<header class="header2">
	...
	<div class="container">
		...
		<div class="row"><div class="hi1 mx-auto tright"><?php echo $this->session->userdata('real_est'); ?></div></div>
					   <?php       if ($kat_bilgi): foreach ($kat_bilgi as $dizi):  ?>  
      <div class="row margin10"><div class="col-12 bld tright"><a class="bld" href="<?php echo base_url(); ?>frs"><?php echo $this->session->userdata('bread_ana'); ?></a> / <a class="bld" href="<?php echo base_url(); ?>frs/projects"><?php echo $this->session->userdata('bread_projects'); ?></a>  / <?php echo strtoupper($dizi["kategori_adi_frs"]); ?> </div></div>
			...
			<div class="col-lg-9 col-md-7 col-sm-12 mx-auto margin30">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 col-6 mx-auto">
						<a href="<?php echo base_url(); ?>frs/<?php echo $dizi["seo_adi"]; ?>">
							<div class="f1">
			...
			<div class="col-lg-3 col-md-5 col-sm-12 mx-auto margin30">
				...
				<div class="lst shadow tright">
					...
					<h4 style="font-size:17px; font-weight: 700"><a title="<?php echo $dizi["kategori_adi_frs"]; ?>" href="<?php echo base_url(); ?>frs/<?php echo $dizi["seo_adi"]; ?>"><?php echo $dizi["kategori_adi_frs"]; ?></a>-</h4>
						   ...
						   -<a title="<?php echo $dizi2["kategori_adi_frs"]; ?>" href="<?php echo base_url(); ?>frs/<?php echo $dizi2["seo_adi"]; ?>"><?php echo $dizi2["kategori_adi_frs"]; ?></a><br>
						   <?php 	   endforeach;endif;  ?>
