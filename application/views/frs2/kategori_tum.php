...
<head><meta http-equiv="Content-Type" content="text/html; charset=euc-jp">
 ...
 <?php if ($ayar): foreach ($ayar as $dizi):
         $desc=$dizi["proje_description_frs"];
         $tit=$dizi["proje_title_frs"];		 
 endforeach; endif;   ?> 
...
<header class="header2">
	...
	<div class="container">
      ...
      <div class="row margin10"><div class="col-12 bld tright"><a class="bld" href="<?php echo base_url(); ?>frs"><?php echo $this->session->userdata('bread_ana'); ?></a> / <?php echo $this->session->userdata('bread_projects'); ?>  </div></div>
...
<?php if($page>0){ ?>
                ...
                <ul class="pagination">
                     <?php if($p>=2){ ?>  
                  <li class="page-item">
                    <a class="page-link" href="<?php echo base_url(); ?>frs/projects/<?php echo $p-1; ?>"><i class="fa fa-angle-left"></i></a>
                  </li> <?php } ?> 
<?php for($n=2; $n<=$page; $n++){ ?>
                  <li class="page-item">
                    <a class="page-link" href="<?php echo base_url(); ?>frs/projects/<?php echo $n; ?>"><?php echo $n; ?></a>
                  </li>
<?php  } ?>				      <?php if($p<$page){ ?>    
                  <li class="page-item">
                    <a class="page-link" href="<?php echo base_url(); ?>frs/projects/<?php if($p==""){ echo $p+2; } else{echo $p+1; }  ?>"><i class="fa fa-angle-right"></i></a>
                  </li> <?php } ?> 
                </ul>
              </nav> 
			...
			<div class="col-lg-3 col-md-5 col-sm-12 mx-auto margin30">
				...
				<div class="lst shadow tright">
					...
					<h4 style="font-size:17px; font-weight: 700"> <a title="<?php echo $dizi["kategori_adi_frs"]; ?>" href="<?php echo base_url(); ?>frs/<?php echo $dizi["seo_adi"]; ?>"><?php echo $dizi["kategori_adi_frs"]; ?></a> -</h4>
						   ...
						   -<a title="<?php echo $dizi2["kategori_adi_frs"]; ?>" title="<?php echo $dizi2["kategori_adi_frs"]; ?>" href="<?php echo base_url(); ?>frs/<?php echo $dizi2["seo_adi"]; ?>"><?php echo $dizi2["kategori_adi_frs"]; ?></a><br>
						   <?php 	   endforeach;endif;  ?>
...
<option data-countryCode="GB" value="44" Selected>UK (+44)</option>
	...
	<optgroup label="Other countries">
      ...
      <div class="col-lg-4 col-12 mx-auto">
	   ...
	   <?php       if ($ayar): foreach ($ayar as $dizi): ?>  
          <div class="tel">
            <div class="tel1"><img alt=""  style="margin-left:20px;"  style="margin-left:20px;" src="<?php echo base_url(); ?>assets_user/frs/img/i2.png"></div>
            <div class="tel2">
          ...
          <div class="wts margin20">
            <div class="tel1"><img alt=""  style="margin-left:20px;" style="margin-left:20px;" src="<?php echo base_url(); ?>assets_user/frs/img/wht.png" width="auto"></div>
            <div class="tel2">
