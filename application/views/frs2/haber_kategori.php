...
<head><meta http-equiv="Content-Type" content="text/html; charset=euc-jp">
 ...
 <?php if($prop=="") { if ($ayar): foreach ($ayar as $dizi):
         $desc=$dizi["news_description_frs"];
         $tit=$dizi["news_title_frs"];		 
...
<?php echo $this->session->userdata('haber_manset_yazi'); ?>			
      ...
      <div class="row margin10"><div class="col-12 bld tright"><a class="bld" href="<?php echo base_url(); ?>frs"><?php echo $this->session->userdata('bread_ana'); ?></a>  / <?php if($prop!=""){ ?> <a class="bld" href="<?php echo base_url(); ?>frs/news"> <?php } ?> <?php echo $this->session->userdata('bread_news'); ?> <?php if($prop!=""){ ?> </a> <?php } ?>  <?php if($prop!=""){ ?> / <?php echo strtoupper($haber_kat_adi); ?> <?php } ?> </div></div>
...
<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-5 col-md-12 margin20">
				...
				<a  title="<?php echo $dizi["baslik_frs"]; ?>" href="<?php echo base_url(); ?>frs/<?php echo $dizi["seo_adi"]; ?>"><img alt="<?php echo $dizi["banner_2_alt"]; ?>" title="<?php echo $dizi["banner_2_title"]; ?>" class="sl0 shadow" width="100%" src="<?php echo base_url(); ?>assets/resimler/<?php echo $dizi["banner_2"]; ?>"></a>
				<div class="nw1 tright">
							<a title="<?php echo $dizi["baslik_frs"]; ?>" href="<?php echo $dizi["seo_adi"]; ?>"><?php echo $dizi["baslik_frs"]; ?></a></div>
		...
		<div class="col-lg-2 col-md-2 col-sm-12 mx-auto margin30">
				...
				<div class="lst shadow tright">
					...
					<h4 style="font-size:17px; font-weight: 700"> <a title="<?php echo $dizi["kategori_adi_frs"]; ?>" href="<?php echo base_url(); ?>frs/<?php echo $dizi["seo_adi"]; ?>"><?php echo $dizi["kategori_adi_frs"]; ?></a> -</h4>
					<?php  	   endforeach;endif;  ?>  		
					<h4 style="font-size:17px; font-weight: 700"> <a href="<?php echo base_url(); ?>frs/buyer_guide"><?php echo $this->session->userdata('buyer_guide_kucuk'); ?></a> -</h4>
...
<div class="row tright">
		<?php $n=0; if ($kat_haber): foreach ($kat_haber as $dizi):  ?> 
						...
						<div class="nw1 tright">
							<a  title="<?php echo $dizi["baslik"]; ?>" href="<?php echo base_url(); ?>frs/<?php echo $dizi["seo_adi"]; ?>"><?php echo $dizi["baslik_frs"]; ?></a></div>
...
<div class="row tright">		
	...
	<?php if($prop=="") { if($page>0){ ?>
                ...
                <ul class="pagination">
                         <?php if($p>=2){ ?>    
                  <li class="page-item">
                    <a class="page-link" href="<?php echo base_url(); ?>frs/news/<?php echo $p-1; ?>"><i class="fa fa-angle-left"></i></a>
                  </li>
                   <?php } ?> 
<?php for($n=2; $n<=$page; $n++){ ?>
                  <li class="page-item">
                    <a class="page-link" href="<?php echo base_url(); ?>frs/news/<?php echo $n; ?>"><?php echo $n; ?></a>
                  </li>
<?php  } ?>				   <?php if($p<$page){ ?>   
                  <li class="page-item">
                    <a class="page-link" href="<?php echo base_url(); ?>frs/news/<?php if($p==""){ echo $p+2; } else{echo $p+1; } ?>"><i class="fa fa-angle-right"></i></a>
                  </li><?php } ?>
                </ul>
              </nav> 
...
?>		
			...
			<div class="row margin40">
                ...
                <ul class="pagination">
                         <?php if($p>=2){ ?>    
                  <li class="page-item">
                    <a class="page-link" href="<?php echo base_url(); ?>frs/<?php echo $prop; ?>/<?php echo $p-1; ?>"><i class="fa fa-angle-left"></i></a>
                  </li>
                   <?php } ?> 
<?php for($n=2; $n<=$page; $n++){ ?>
                  <li class="page-item">
                    <a class="page-link" href="<?php echo base_url(); ?>frs/<?php echo $prop; ?>/<?php echo $n; ?>"><?php echo $n; ?></a>
                  </li>
<?php  } ?>				   <?php if($p<$page){ ?>   
                  <li class="page-item">
                    <a class="page-link" href="<?php echo base_url(); ?>frs/<?php echo $prop; ?>/<?php if($p==""){ echo $p+2; } else{echo $p+1; } ?>"><i class="fa fa-angle-right"></i></a>
                  </li><?php } ?>
                </ul>
              </nav> 
