...
<head><meta http-equiv="Content-Type" content="text/html; charset=euc-jp">
 ...
 <?php  if ($ayar): foreach ($ayar as $dizi):
         $desc=$dizi["contact_description_frs"];
         $tit=$dizi["contact_title_frs"];		 
		 endforeach; endif;   ?> 
...
<header class="header2">
  ...
  <div class="container">
    ...
    <div class="row"><div class="hi1 mx-auto tright"><?php echo $this->session->userdata('real_est'); ?></div></div>
      <div class="row margin10"><div class="col-12 bld tright"><a class="bld" href="<?php echo base_url(); ?>frs"><?php echo $this->session->userdata('bread_ana'); ?></a> / <?php echo $this->session->userdata('bread_iletisim'); ?></div></div>
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-12 mx-auto margin60">
        ...
        <div class="row shadow i2">
          <div class="col-lg-6 col-md-12 col-sm-12 margin30">        <div class="tel1"><img style="margin-left:20px;" alt="" class="mb1" src="<?php echo base_url(); ?>assets_user/frs/img/i2.png"></div>
            <div class="tel2 tright">
              <span class="tel3-1 tright"><?php echo $this->session->userdata('phone_number'); ?></span>
              <div class="itel3 tright"><?php echo $dizi["tel_1_frs"]; ?></div>
            </div></div>
          <div class="col-lg-6 col-md-12 col-sm-12 margin30">
            ...
            <div class="tel2 tright">
              ...
              <div  class="itel3 tright"><?php echo $dizi["whatsapp_frs"]; ?></div>
            </div>
              ...
              <div class="row margin50">
               <div class="col-10 tright"><?php echo $dizi["adress_frs"]; ?></div>

                <div class="col-1"><i class="fa fa-map-marker" style="font-size:1.8em" aria-hidden="true"></i></div>
              </div>

              <div class="row margin30">
                                <div class="col-10 tright"><?php echo $dizi["tel_1_frs"]; ?></div>

                <div class="col-1"><img alt="" height="18" src="<?php echo base_url(); ?>assets_user/frs/img/tel.png"></div>
              </div>

              <div class="row margin30">
                                <div class="col-10 tright"><?php echo $dizi["whatsapp_frs"]; ?></div>

                <div class="col-1"><img alt="" height="18" src="<?php echo base_url(); ?>assets_user/frs/img/cep.png"></div>
              </div>

              <div class="row margin30">
                                <div class="col-10 tright"><?php echo $dizi["email"]; ?></div>

                <div class="col-1"><img alt="" height="19" width="auto" src="<?php echo base_url(); ?>assets_user/frs/img/mail.png"></div>
              </div>   
