...
<form id="upload" method="post" action="<?php echo base_url(); ?>yonetim/fotolar_upload_2" enctype="multipart/form-data">
	<div id="drop">
		Sürükle 
		<a>Aç</a>
...
#zoom:hover {
  ...
  transform: scale(2); /* (150% zoom - Note: if the zoom is too large, it will go outside of the viewport) */
		...
		<center>	<img style="width:25%; position:relative;" id="zoom" src="<?php echo base_url(); ?>assets/resim_url/<?php  echo $dizi['foto']; ?>">
				<br><a href="<?php echo base_url(); ?>yonetim/foto_sil_2/<?php  echo $dizi['id']; ?>/<?php  echo $dizi['foto']; ?>"><i>Sil</i></a><br> Url: <?php echo base_url(); ?>assets/resim_url/<?php  echo $dizi['foto']; ?>
