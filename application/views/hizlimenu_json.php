...
<?php  if ($data['side_menu']=="Cari Ayarları"){ ?>
	...
	self.buttons[0] = {
					group_name: 'Teklif',
					grup_buttons: [
						{name: 'Alınan Teklif ekle', link: 'yonetim/alinan_teklif_olustur', isSpecific: false, type: 'add'},
						{name: 'Verilen Teklif ekle', link: 'yonetim/verilen_teklif_olustur', isSpecific: false},
				...
				self.buttons[1] = {
					group_name: 'Sipariş',
					grup_buttons: [
						{name: 'Gelen Sipariş Ekle', link: 'yonetim/gelen_siparis_olustur', isSpecific: false},
						{name: 'Giden Sipariş Ekle', link: 'yonetim/giden_siparis_olustur', isSpecific: false},
				...
				self.buttons[2] = {
					group_name: 'İrsaliye',
					grup_buttons: [
						{name: 'Satış İraliye Ekle', link: 'yonetim/satis_irsaliye_olustur', isSpecific: false},
						{name: 'Alış İrsaliye Ekle', link: 'yonetim/alis_irsaliye_olustur', isSpecific: false},
				...
				self.buttons[3] = {
					group_name: 'Fatura',
					grup_buttons: [
						{name: 'Satış Fatura Ekle', link: 'yonetim/satis_fatura_olustur', isSpecific: false},
						{name: 'Alış Fatura Ekle', link: 'yonetim/alis_fatura_olustur', isSpecific: false},
...
<?php  if ($data['side_menu']=="Hizmet Ürün Ayarları"){ ?>
	...
	self.buttons[2] = {
					...
					grup_buttons: [
						...
						{name: 'Stok detay', link: 'yonetim/stok_detay_git/', isSpecific: true},
...
<?php  if ($data['side_menu']=="Teklif Ayarları"){ ?>
	...
	self.buttons[0] = {
				group_name: 'Teklif',
					grup_buttons: [
						{name: 'Teklif Düzenle', link: 'yonetim/teklif_duzenle', isSpecific: true},
...
<?php  if ($data['side_menu']=="Sipariş Ayarları"){ ?>
	...
	self.buttons[0] = {
				group_name: 'Sipariş',
					grup_buttons: [
						{name: 'Sipariş Düzenle', link: 'yonetim/siparis_duzenle', isSpecific: true},
...
<?php  if ($data['side_menu']=="İrsaliye Ayarları"){ ?>
	...
	self.buttons[0] = {
				group_name: 'İrsaliye',
					grup_buttons: [
						{name: 'İrsaliye Düzenle', link: 'yonetim/irsaliye_duzenle', isSpecific: true},
...
<?php  if ($data['side_menu']=="Fatura Ayarları"){ ?>
	...
	self.buttons[0] = {
				group_name: 'Fatura',
					grup_buttons: [
						{name: 'Fatura Düzenle', link: 'yonetim/fatura_duzenle', isSpecific: true},
