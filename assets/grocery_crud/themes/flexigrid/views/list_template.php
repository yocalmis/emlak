...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<?php }?>
<input type="text" id="search" value="" placeholder="Tabloda Ara" style="background:#FFFFFF; color:#000000; width:25%; font-weight:bold; box-sizing: border-box; border: 2px solid #d5d3d3;"></input>
